<%@ Page Title="Binary Income Report" Language="C#" MasterPageFile="usermaster.master" AutoEventWireup="true" CodeFile="BinaryIncomeReport.aspx.cs" Inherits="admin_UserReport" %>
        ...
        <ContentTemplate>
            <div class="ab-wm">
                <div class="ab-page-head">
                    <h2>Binary Income Report</h2>
                    <p>Search and view binary matching income records.</p>
                </div>
                ...
                <div class="ab-section">
                    <div class="ab-section-head">
                        ...
                        <div>
                            <h3>Binary Income List</h3>
                            <span>Matching binary income records</span>
                        </div>
                    </div>
