...
public partial class User_test : System.Web.UI.Page
{
    ...
    void loadbinary(string str_superid)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            lblusername1.Text = "<a href='test.aspx?SuperId=" + dt.Rows[0]["Userid"].ToString() + @"' >" + dt.Rows[0]["username"].ToString() + "(" + dt.Rows[0]["amount"].ToString() + @")</a>";
            ...
            if (dt2.Rows.Count > 0)
            {
                ...
                lblusername2.Text = "<a href='test.aspx?SuperId=" + dt2.Rows[0]["Userid"].ToString() + @"' >" + dt2.Rows[0]["username"].ToString() + "(" + dt2.Rows[0]["amount"].ToString() + @")</a>";
            ...
            if (dt3.Rows.Count > 0)
            {
                ...
                lblusername3.Text = "<a href='test.aspx?SuperId=" + dt3.Rows[0]["Userid"].ToString() + @"' >" + dt3.Rows[0]["username"].ToString() + "(" + dt3.Rows[0]["amount"].ToString() + @")</a>";
            ...
            if (dt4.Rows.Count > 0)
            {
                ...
                lblusername4.Text = "<a href='test.aspx?SuperId=" + dt4.Rows[0]["Userid"].ToString() + @"' >" + dt4.Rows[0]["username"].ToString() + "(" + dt4.Rows[0]["amount"].ToString() + @")</a>";
            ...
            if (dt5.Rows.Count > 0)
            {
                ...
                lblusername5.Text = "<a href='test.aspx?SuperId=" + dt5.Rows[0]["Userid"].ToString() + @"' >" + dt5.Rows[0]["username"].ToString() + "(" + dt5.Rows[0]["amount"].ToString() + @")</a>";
            ...
            if (dt6.Rows.Count > 0)
            {
                ...
                lblusername6.Text = "<a href='test.aspx?SuperId=" + dt6.Rows[0]["Userid"].ToString() + @"' >" + dt6.Rows[0]["username"].ToString() + "(" + dt6.Rows[0]["amount"].ToString() + @")</a>";
            ...
            if (dt7.Rows.Count > 0)
            {
                ...
                lblusername7.Text = "<a href='test.aspx?SuperId=" + dt7.Rows[0]["Userid"].ToString() + @"' >" + dt7.Rows[0]["username"].ToString() + "(" + dt7.Rows[0]["amount"].ToString() + @")</a>";
