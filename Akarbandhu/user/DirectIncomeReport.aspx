<%@ Page Title="Direct Income Report" Language="C#" MasterPageFile="usermaster.master" AutoEventWireup="true" CodeFile="DirectIncomeReport.aspx.cs" Inherits="admin_UserReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentHeader" runat="Server">
    <li class="breadcrumb-item"><a href="Dashboard.aspx"><i class="feather icon-home"></i></a></li>
    <li class="breadcrumb-item"><a href="#">Direct Income Report</a></li>
</asp:Content>
        ...
        <ContentTemplate>
            <div class="ab-wm">
                <div class="ab-page-head">
                    <h2>Direct Income Report</h2>
                    <p>Search and view direct referral income records.</p>
                </div>
                ...
                <div class="ab-section">
                    <div class="ab-section-head">
                        ...
                        <div>
                            ...
                            <span>Filter by date range and customer id</span>
                        </div>
                    </div>
                ...
                <div class="ab-section">
                    <div class="ab-section-head">
                        ...
                        <div>
                            <h3>Direct Income List</h3>
                            <span>Matching direct income records</span>
                        </div>
                    </div>
                            ...
                            <asp:GridView ID="GridView1" runat="server" CssClass="table ab-table table-striped" Width="100%" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" GridLines="None">
                               <Columns>
                                 ...
                                 <%--   <asp:TemplateField HeaderText="Transaction Id">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblamount" runat="server" Text='<%#Eval("cramount") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>   
