<%@ Page Title="Wallet Transfer Report" Language="C#" MasterPageFile="usermaster.master" AutoEventWireup="true" CodeFile="WalletTransferReport.aspx.cs" Inherits="admin_UserReport" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentHeader" runat="Server">
    <li class="breadcrumb-item"><a href="Dashboard.aspx"><i class="feather icon-home"></i></a></li>
    <li class="breadcrumb-item"><a href="#">Wallet Transfer Report</a></li>
</asp:Content>
        ...
        <ContentTemplate>
            <div class="ab-wm">
                <div class="ab-page-head">
                    <h2>Wallet Transfer Report</h2>
                    <p>Search and review wallet transfer transactions.</p>
                </div>
                ...
                <div class="ab-section">
                    <div class="ab-section-head">
                        ...
                        <div>
                            ...
                            <span>Filter transfers by date and user</span>
                        </div>
                    </div>
                ...
                <div class="ab-section">
                    <div class="ab-section-head">
                        ...
                        <div>
                            <h3>Wallet Transfer Report</h3>
                            <span>Matching wallet transfer records</span>
                        </div>
                    </div>
