<%@ Page Title="Wallet Transfer Report" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="WalletTransferReport.aspx.cs" Inherits="admin_UserReport" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <div class="card-body">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-3">
                                        <asp:TextBox ID="txtfromuserid"  CssClass="form-control" runat="server"></asp:TextBox>
                                    </div>
           ...
           <div class="card">
        <div class="card-header">
            <strong>Wallet Transfer Report</strong>
        </div>
        <div class="card-body">
                               ...
                               <Columns>
                                   ...
                                   <asp:TemplateField HeaderText="From User Id">
                                     ...
                                     <asp:TemplateField HeaderText="To User Id">
                                        <ItemTemplate>
                                            <asp:Label ID="lbluserid" runat="server" Text='<%#Eval("touserid") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
