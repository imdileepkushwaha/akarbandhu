<%@ Page Title="Generate Sale ROI Closing" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="SaleROIClosingGenerate.aspx.cs" Inherits="admin_EPinAdd" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentHeader" Runat="Server">
      	 <li class="breadcrumb-item"><a href="Dashboard.aspx"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#">Generate Sale ROI Closing</a></li>
</asp:Content>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
       ...
       <div class="card">
        <div class="card-header">
            <strong>Generate Sale ROI Closing</strong>
        </div>
        ...
        <div class="card-body">
                        <div class="row form-group">
                            ...
                            <div class="col-md-3">
                                 <asp:TextBox ID="txttodate"  CssClass="form-control form_date" autocomplete="off" Enabled="false"  runat="server"></asp:TextBox>
                            </div>
