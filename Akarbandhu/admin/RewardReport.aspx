<%@ Page Title="Reward Report" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="RewardReport.aspx.cs" Inherits="admin_UserReport"  ValidateRequest="false" EnableEventValidation="false" %>
                               ...
                               <Columns>
                                 ...
                                 <%--   <asp:TemplateField HeaderText="Level">
                                     ...
                                     <asp:TemplateField HeaderText="Matching Business">
                                        <ItemTemplate>
                                            <asp:Label ID="lbllevel" runat="server" Text='<%#Eval("MatchingBusiness") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                   <asp:TemplateField HeaderText="Power Leg Business">
                                        <ItemTemplate>
                                            <asp:Label ID="lbllevesl" runat="server" Text='<%#Eval("PowerLegBusiness") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
