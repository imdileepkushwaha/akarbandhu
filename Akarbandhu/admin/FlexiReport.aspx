<%@ Page Title="Flexi Plan Booking Report" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="FlexiReport.aspx.cs" Inherits="admin_UserReport" ValidateRequest="false" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentHeader" runat="Server">
    <li class="breadcrumb-item"><a href="Dashboard.aspx"><i class="feather icon-home"></i></a></li>
    <li class="breadcrumb-item"><a href="#">Flexi Booking Report</a></li>
</asp:Content>
        ...
        <ContentTemplate>
            <div class="ab-wm">
                <div class="ab-page-head">
                    <h2>Flexi Booking Report</h2>
                    <p>Search, export and manage flexi plan bookings.</p>
                </div>
                ...
                <div class="ab-section">
                    <div class="ab-section-head">
                        ...
                        <div>
                            <h3>Booking List</h3>
                            <span>Matching flexi plan bookings</span>
                        </div>
                    </div>
                    <div class="ab-section-body ab-section-body--flush">
                        <div class="table-responsive">
                            <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound" CssClass="table ab-table table-striped" ShowFooter="true" Width="100%" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" GridLines="None">
                                <Columns>
                                    <asp:TemplateField HeaderText="#">
                                        <ItemTemplate>
                                            <%#Container.DataItemIndex+1 %>
                                            <asp:Label ID="lblpaymentstatus" Visible="false" Text='<%#Eval("paymentstatus") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="btnInst" runat="server" CommandName="Inst" CssClass="ab-btn-inst" ToolTip="Pay Installment" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>">
                ...
                <asp:Panel ID="pnlInstallment" runat="server" Visible="false">
                    ...
                    <div class="ab-section">
                            ...
                            <div class="ab-pay-form">
                                ...
                                <div class="row">
                                    <div class="col-md-4 ab-field">
                                        ...
                                        <asp:TextBox ID="txtinstamount" CssClass="form-control" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="col-md-4 ab-field">
                        ...
                        <div class="ab-actions">
                            <asp:Button ID="btnPay" CssClass="btn btn-primary" runat="server" Text="Submit Payment" OnClick="btnPay_Click" />
                        </div>
                    </div>
                </asp:Panel>
            </div>
