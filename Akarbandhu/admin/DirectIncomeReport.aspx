<%@ Page Title="Direct Income Report" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="DirectIncomeReport.aspx.cs" Inherits="admin_UserReport" ValidateRequest="false" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentData" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <div class="card-body">
           ...
           <div class="card">
        <div class="card-header">
            <strong>Direct  Income Report</strong>
        </div>
                               ...
                               <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Transaction Id">
                                     ...
                                     <asp:TemplateField HeaderText="Booking Id">
                                        <ItemTemplate>
                                            <asp:Label ID="lblremark" runat="server" Text='<%#Eval("accountno") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>   
                                                        <asp:TemplateField HeaderText="Inst Amt">
                                        <ItemTemplate>
                                            <asp:Label ID="lblamoudfsdfnt" runat="server" Text='<%#Eval("business") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>   
