<%@ Page Title="Flexi Plan Booking" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="FlexiBooking.aspx.cs" Inherits="admin_UserAdd" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentHeader" runat="Server">
    <li class="breadcrumb-item"><a href="Dashboard.aspx"><i class="feather icon-home"></i></a></li>
    <li class="breadcrumb-item"><a href="#">Flexi Booking</a></li>
</asp:Content>
        ...
        <ContentTemplate>
            <div class="ab-wm">
                <div class="ab-page-head">
                    <h2>Flexi Plan Booking</h2>
                    <p>Create a new flexi plan booking for a customer.</p>
                </div>
                ...
                <div class="ab-section">
                    <div class="ab-section-head">
                        ...
                        <div>
                            <h3>Amounts</h3>
                            <span>Plot and payment amounts</span>
                        </div>
                    </div>
                    <div class="ab-section-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 ab-field">
                                ...
                                <asp:TextBox ID="txtplotamount" CssClass="form-control" Enabled="false" onkeypress="return isNumberKey(event);" runat="server"></asp:TextBox>
                            </div>
                            <div class="col-md-4 ab-field">
