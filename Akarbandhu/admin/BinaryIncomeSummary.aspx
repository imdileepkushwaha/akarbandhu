<%@ Page Title="Binary Income Report (Summary)" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="BinaryIncomeSummary.aspx.cs" Inherits="admin_UserReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentHeader" runat="Server">
      <h3 class="main-title">Binary Income Report(Summary)</h3>
    <span>Dashboard / Binary Income Report (Summary) </span>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="contentData" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <div class="card-body">
          ...
          <div class="card">
        <div class="card-header">
            <strong>Binary Income Report (Summary)</strong>
        </div>
