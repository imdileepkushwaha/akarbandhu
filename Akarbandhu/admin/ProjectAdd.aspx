                            ...
                            <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover" Width="100%" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Project Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblbankname" runat="server" Text='<%#Eval("projectname") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <asp:Label ID="lblbankid" Visible="false" runat="server" Text=""></asp:Label>
                                 <asp:Label ID="txtbanknameedit" Visible="false" runat="server" Text=""></asp:Label>
                                <asp:TextBox runat="server" Visible="true" class="form-control" ID="txtprojectnameedit"></asp:TextBox>
                            </div>
                        </div>
