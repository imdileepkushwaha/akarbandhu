                            ...
                            <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-hover" Width="100%" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" OnRowDataBound="GridView1_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lbactive" CommandName="myactive" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" runat="server">Active</asp:LinkButton>
                                            <asp:LinkButton ID="llbdeactive" CommandName="mydeactive" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" runat="server">Deactive</asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
