<%@ Page Title="Associate Advance Repayment" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="AssociateRepayment.aspx.cs" EnableEventValidation="false" Inherits="admin_ProjectAdd" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="contentHeader" runat="Server">
    <li class="breadcrumb-item"><a href="Dashboard.aspx"><i class="feather icon-home"></i></a></li>
    <li class="breadcrumb-item"><a href="#">Associate Repayment</a></li>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentData" runat="Server">
    <div class="ab-wm">
        <div class="ab-page-head">
            <h2>Associate Advance Repayment</h2>
            <p>Record advance repayment for an associate.</p>
        </div>
        ...
        <div class="ab-section">
            <div class="ab-section-head">
                ...
                <div>
                    ...
                    <span>Enter associate and repayment information</span>
                </div>
            </div>
