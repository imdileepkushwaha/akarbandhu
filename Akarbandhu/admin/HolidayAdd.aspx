    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <div class="card-body">
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-3">
                                        <asp:TextBox ID="txtdate" CssClass="form-control form_date" autocomplete="off" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <hr />
                        ...
                        <div class="modal-body">
                            ...
                            <asp:Label ID="lblholidayid" Visible="false" runat="server" Text=""></asp:Label>
                             ...
                             <div class="form-group">
                                ...
                                <asp:TextBox runat="server" class="form-control form_date" autocomplete="off" ID="txtdateedit"></asp:TextBox>
                            </div>
                        </div>
