<%@ Page Title="ROI Income Report (Summary)" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="ROIIncomeSummary.aspx.cs" Inherits="admin_UserReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentHeader" runat="Server">
     <h3 class="main-title">ROI Income Report (Summary) </h3>
    <span>Dashboard / ROI Income Report (Summary) </span>
</asp:Content>
        ...
        <div class="card-body">
                                  ...
                                  <div class="row form-group">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="col-md-2">ROI Type</div>
                                    <div class="col-md-2">
                                        <asp:DropDownList ID="ddroitype" CssClass="form-control" runat="server">
                                            <asp:ListItem Value="0">Select Type</asp:ListItem>
                                            <asp:ListItem>Normal</asp:ListItem>
                                            <asp:ListItem>Booster1</asp:ListItem>
                                            <asp:ListItem>Booster2</asp:ListItem>
                                            <asp:ListItem>Booster3</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
               ...
               <div class="card">
        <div class="card-header">
            <strong>ROI Income Report (Summary)</strong>
        </div>
        <div class="card-body">
                               ...
                               <Columns>
                                  ...
                                  <asp:TemplateField HeaderText="Date">
                                     ...
                                     <asp:TemplateField HeaderText="Type">
                                        <ItemTemplate>
                                            <asp:Label ID="lblremark" runat="server" Text='<%#Eval("roitype") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
