<%@ Page Title="Associate Withdrawl Request Report" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="AssociateWithdrawlRequestReport.aspx.cs" Inherits="admin_UserReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="contentHeader" runat="Server">
    <li class="breadcrumb-item"><a href="Dashboard.aspx"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#">Associate Withdrawal Request Report</a></li>
</asp:Content>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Associate Name">
                                 ...
                                 <asp:TemplateField HeaderText="Bank Detail">
                                    <ItemTemplate>
                                       Bank Name : <asp:Label ID="lblbankname" runat="server" Text='<%#Eval("BankName") %>'></asp:Label> <br /> 
                                       Account Number :  <asp:Label ID="lblaccnumber" runat="server" Text='<%#Eval("AccountNo") %>'></asp:Label> <br />
                                    IFSC  :   <asp:Label ID="lblifsc" runat="server" Text='<%#Eval("IFSCCode") %>'></asp:Label> <br />
