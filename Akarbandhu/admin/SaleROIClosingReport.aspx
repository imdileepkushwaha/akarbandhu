<%@ Page Title="Sale Closing Report" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="SaleROIClosingReport.aspx.cs" Inherits="admin_UserReport" %>
                                    ...
                                    <asp:TemplateField HeaderText="From Date">
                                     ...
                                     <asp:TemplateField HeaderText="Distribution Amt">
                                       ...
                                       <asp:TemplateField HeaderText="Inst No">
                                        <ItemTemplate>
                                            <asp:Label ID="lblbusamy" runat="server" Text='<%#Eval("instno") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
