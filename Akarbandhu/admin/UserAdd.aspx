<%@ Page Title="Add Customer" Language="C#" MasterPageFile="adminmaster.master" AutoEventWireup="true" CodeFile="UserAdd.aspx.cs" Inherits="admin_UserAdd" %>
        ...
        <ContentTemplate>
            <div class="ab-wm">
                <div class="ab-page-head">
                    <h2>Add Customer</h2>
                    <p>Register a new customer with sponsor, personal and nominee details.</p>
                </div>
                ...
                <div class="ab-section">
                    <div class="ab-section-head">
                        ...
                        <div>
                            <h3>Sponsor</h3>
                            <span>Link customer to a sponsor</span>
                        </div>
                    </div>
                ...
                <div class="ab-section">
                    <div class="ab-section-head">
                        ...
                        <div>
                            ...
                            <span>Basic customer information</span>
                        </div>
                    </div>
                    <div class="ab-section-body">
                        <div class="row">
                ...
                <div class="ab-section">
                    <div class="ab-section-head">
                        ...
                        <div>
                            <h3>Location &amp; KYC</h3>
                            <span>Address, identity and pin details</span>
                        </div>
                    </div>
                    <div class="ab-section-body">
                        <div class="row">
