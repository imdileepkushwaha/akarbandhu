...
public partial class admin_UserReport : System.Web.UI.Page
{
    ...
    void loadclosingperiod()
    {
        ...
        dt = objclosing.getClosingPeriodReward();
    ...
    void loaduser()
    {
        ...
        DataTable dt = new DataTable();
        dt = getRewardReport(objaccount, Fromfdate, Todatedate);
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=rewardreport.xls");
        Response.Charset = "";
