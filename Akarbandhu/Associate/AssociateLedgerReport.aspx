        ...
        <ContentTemplate>
            <div class="ab-wm">
                <div class="ab-page-head">
                    ...
                    <p>View payout, advance and balance entries in your ledger.</p>
                </div>
                ...
                <div class="ab-section">
                    <div class="ab-section-head">
                        ...
                        <div>
                            ...
                            <span>Filter ledger by associate id</span>
                        </div>
                    </div>
                ...
                <div class="ab-section">
                    <div class="ab-section-head">
                        ...
                        <div>
                            <h3>Ledger List</h3>
                            <span>Matching ledger transactions</span>
                        </div>
                    </div>
                    <div class="ab-section-body ab-section-body--flush">
                        <div class="table-responsive">
                            <asp:GridView ID="GridView1" PageSize="15" AutoGenerateColumns="false" CssClass="table ab-table table-striped" runat="server" GridLines="None" Width="100%">
                                <Columns>
