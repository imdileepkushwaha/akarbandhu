<%@ Page Title="Villa Fund Income Report" Language="C#" MasterPageFile="associatemaster.master" AutoEventWireup="true" CodeFile="VillaFundIncomeReport.aspx.cs" Inherits="admin_UserReport" %>
        ...
        <ContentTemplate>
            <div class="ab-wm">
                <div class="ab-page-head">
                    <h2>Villa Fund Income Report</h2>
                    <p>Search and view villa fund income records.</p>
                </div>
                ...
                <div class="ab-section">
                    <div class="ab-section-head">
                        ...
                        <div>
                            ...
                            <span>Filter by date range and associate id</span>
                        </div>
                    </div>
                ...
                <div class="ab-section">
                    <div class="ab-section-head">
                        ...
                        <div>
                            <h3>Villa Fund Income List</h3>
                            <span>Matching villa fund income records</span>
                        </div>
                    </div>
