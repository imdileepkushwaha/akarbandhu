...
public partial class admin_UserReport : System.Web.UI.Page
{
    ...
    void loaddata()
    {
        ...
        objbooking.UserId = Session["associateid"].ToString();
        ...
        DataTable dt = new DataTable();
        dt = objbooking.getFPBookingAssociate(objbooking);
        if (dt.Rows.Count > 0)
        {
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Inst")
        {
            ...
            objbooking.BookingId = lblregid.Text;
            dt2 = objbooking.getBookingDetailForFlexiInst(objbooking);
            ...
            if (dt2.Rows.Count > 0)
            {
                ...
                txtinstamount.Text = dt2.Rows[0]["instamt"].ToString();
    ...
    protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            LinkButton btnInst = (LinkButton)e.Row.FindControl("btnInst");
    ...
    protected void btnPay_Click(object sender, EventArgs e)
    {
        if (txtpaymentdate.Text != "")
        {
            if (ddpaymentmode.SelectedValue.ToString() != "0")
            {
                ...
                objbooking.InstAmount = Convert.ToDecimal(txtinstamount.Text);
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=ipreport.xls");
        Response.Charset = "";
