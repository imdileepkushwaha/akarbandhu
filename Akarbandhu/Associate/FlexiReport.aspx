<%@ Page Title="Flexi Plan Booking Report" Language="C#" MasterPageFile="associatemaster.master" AutoEventWireup="true" CodeFile="FlexiReport.aspx.cs" Inherits="admin_UserReport" ValidateRequest="false" EnableEventValidation="false" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentData" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="card">
                <div class="card-header">
                    <strong>Flexi Plan Booking Report</strong>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound"
                            CssClass="table table-bordered table-hover" ShowFooter="true" Width="100%" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Action">
                                    <ItemTemplate>
                                        <a href='BookingReceipt.aspx?BookingId=<%#Eval("accountno") %>' class="btn btn-info btn-sm" target="_blank">Receipt</a> &nbsp;
                                         <asp:LinkButton ID="btnInst" runat="server" CommandName="Inst" CssClass="btn btn-success btn-sm" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>">Inst</asp:LinkButton>
                                        <%--    
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="grdInstallment" PageSize="15" AutoGenerateColumns="false" CssClass="table table-bordered table-striped table-hover" runat="server" OnRowDataBound="grdInstallment_RowDataBound">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <a href='InstallmentReceipt.aspx?BookingId=<%#Eval("accountno") %>&instno=<%# Eval("InstNo") %>' class="btn btn-info btn-xs" target="_blank">Receipt</a> &nbsp;
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
