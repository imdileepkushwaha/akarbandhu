...
<head id="Head1" runat="server">
  <title>Akar Bandhu Pvt Ltd — Associate Login</title>
	<!--[if lt IE 11]>
	...
	<meta name="description" content="Akar Bandhu Pvt Ltd Associate Portal" />
	...
	<style>
		...
		.ab-modal .btn-primary,
		.ab-modal .btn-success {
  ...
  <div class="ab-shell">
	<section class="ab-hero" aria-label="Brand">
		<div class="ab-hero-inner">
			...
			<p class="ab-tagline">Associate portal — sign in to manage your network, earnings, and business tools.</p>
		</div>
	</section>
	...
	<section class="ab-panel">
		<div class="ab-form-wrap">
			...
			<p class="ab-form-label">Associate access</p>
			<h2 class="ab-form-title">Welcome back</h2>
			<p class="ab-form-sub">Enter your credentials to continue.</p>
                        ...
                        <div class="modal-body">
                            ...
                            <asp:Panel ID="pnlForgotStep1" runat="server">
                                <div class="ab-field" style="margin-bottom:0;">
                                    <label for="<%= txtuserid.ClientID %>">Associate Id</label>
                                    <asp:TextBox runat="server" CssClass="form-control" ID="txtuserid" placeholder="Enter your associate id" autocomplete="username"></asp:TextBox>
