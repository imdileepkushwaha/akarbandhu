...
public partial class associate_RewardIncomeReport : System.Web.UI.Page
{
    ...
    void loadclosingperiod()
    {
        ...
        DataTable dt = objclosing.getClosingPeriodReward();
    ...
    void loaduser()
    {
        ...
        DataTable dt = objaccount.getRewardIncomeReport(objaccount, Fromfdate, Todatedate);
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=rewardincomereport.xls");
        Response.Charset = "";
