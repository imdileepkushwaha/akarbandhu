...
namespace BusinessLogicTier
{
    public class clsSetting
    {
        ...
        public String Insert_SystemSettings(int IntervalBtRecharge, int IntervalBtTransfer, int MinFundTransfer, int MaxFundTransfer, int BackDate, int EntryBy, string DMRVerification)
        {
            string res = "";
            string s2 = "";
            SqlConnection cn;
