    ...
    public class clsSupport
    {
        ...
        public int SendMessage(clsSupport objsupport)
        {
            ...
            try
            {
                ...
                s2 = " declare @id int; SELECT @id= isnull(max(id),0)+1 from SupportDetail  ; insert into SupportDetail (id, FromId ,ToId  ,MessageTitle ,MessageDescription, MentionBy  ,MentionDate  ) values (@id, '" + objsupport.FromId + "', '" + objsupport.ToId + "','" + objsupport.Messagetitle + "','" + objsupport.MessageDescription + "','" + objsupport.MentionBy + "',getdate()) ";
        ...
        public int SendMessageByAdmin(clsSupport objsupport)
        {
            ...
            try
            {
                ...
                dt = ObjData.RunSelectQueryTTrans("select * from mlmlogindetail where username='" + objsupport.ToId + "'", tr);
                if (dt.Rows.Count > 0)
                {
